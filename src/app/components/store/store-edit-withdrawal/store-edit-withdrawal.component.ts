...
@Component({
  selector: 'app-store-edit-withdrawal',
  templateUrl: './store-edit-withdrawal.component.html',
  styleUrl: './store-edit-withdrawal.component.scss'
})
export class StoreEditWithdrawalComponent implements OnInit {
  month1: Date | null = null;
  month2: Date | null = null;
  selectedType: string = 'ALL';
  menuLabel: string | null = null;
  menuLabel2: string = 'อนุมัติเบิกสินค้า -> แก้ไขข้อมูลการเบิกสินค้า';
  th: any;
  idcard_emp: string;
  typeData: any[] = [];
  historyData: any[] = [];
